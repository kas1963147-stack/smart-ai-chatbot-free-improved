...
class AgentRegistry
{
    /** @var string Path to agents directory */
    private static string $agentsPath;
    
    /** @var array Cached agent configurations */
    private static array $cache = [];
    
    /** @var bool Whether the cache is initialized */
    ...
    /**
     * Create a new agent directory and file
     */
    public static function createAgent(array $config): bool
    {
        ...
        // Generate and write the AGENT.php file
    ...
    public static function updateRegistry(): void
    {
        ...
        $registryPath = self::$agentsPath . '/_registry.json';
