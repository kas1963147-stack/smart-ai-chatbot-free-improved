...
tools_required: [woo_product_manage, woo_product_details, ecommerce_search_products, woo_variations, woo_reports, email]
always_on: false
group: woocommerce
order: 9
...
- Search inventory with `ecommerce_search_products`
