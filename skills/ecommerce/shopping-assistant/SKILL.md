...
tools_required: [ecommerce_search_products, woo_product_details, woo_cart_enhanced, ecommerce_order_track]
always_on: false
---
...
## Product Search Flow
1. Use `ecommerce_search_products` to find matching products
...
2. Use `ecommerce_order_track` to look up status
