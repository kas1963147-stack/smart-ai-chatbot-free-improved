...
tools_required: [woo_product_manage, woo_product_details, woo_search_products, seo_meta, seo_schema, wp_media]
always_on: false
group: woocommerce
order: 2
...
1. **Search Products**
   - Find products needing updates with `woo_search_products`
