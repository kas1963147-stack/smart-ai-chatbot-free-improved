<?php
/**
 * Plugin Name: Quarksol AI Chatbot & Agent Workflows
 * Description: AI-powered chatbot, autonomous agents, RAG knowledge search, and automated support workflows for WordPress & WooCommerce.
 * Version: 1.1.1
 * Author: Quarksol
...
if (defined('SWC_CHATBOT_VERSION')) {
    add_action('admin_notices', function() {
        echo '<div class="notice notice-error"><p><strong>Smart AI Chatbot:</strong> Another version of the Smart AI Chatbot plugin is already active. Please deactivate the active version first to prevent conflicts.</p></div>';
    });
