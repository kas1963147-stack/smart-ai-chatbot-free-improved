...
class SWC_Chatbot_Mistral_Provider extends SWC_Chatbot_AI_Provider {
     ...
     * Constructor
     */
    public function __construct($api_key, $model = 'mistral-large-latest', $temperature = 0.7, $max_tokens = null) {
    ...
    public function chat($message, $history = array()) {
        ...
        if ($status_code !== 200) {
            ...
            return new WP_Error('mistral_error', 'Mistral API error: ' . $error_message);
        }
        ...
        return new WP_Error('mistral_error', 'Invalid response from Mistral');
    }
